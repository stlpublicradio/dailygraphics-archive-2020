...
var onWindowLoaded = function () {
  var house_data = formatData(window.HOUSE);
  render(house_data, "#stacked-column-chart-house");

  var senate_data = formatData(window.SENATE);
  render(senate_data, "#stacked-column-chart-senate");
